        ...
        <section className="mt-[130px] bg-base-200 p-[45px] pt-[80px]">
          ...
          <div className="p-[30px] rounded-xl lg:col-span-2">
            <form>
              ...
              {/* <button
              type="button"
              className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-primary transition-all duration-300 text-white hover:bg-base-100"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16px"
